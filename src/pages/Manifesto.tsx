    ...
    return (
        <div className="container" style={{ maxWidth: "680px", paddingBlock: "4rem" }}>
            ...
            >
                ...
                <p>This is what happens when builders build for builders because building is the point.</p>
