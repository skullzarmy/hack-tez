    ...
    return (
        <div className="relative inline-flex items-center">
            ...
            <select
                ...
                className="appearance-none border-0 text-[10px] font-bold uppercase tracking-widest cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2"
                style={{
                    background: "var(--accent, #00ffc8)",
                    color: "var(--bg, #000)",
                    fontFamily: "var(--font-mono)",
